...
window.fbControls.push(function (controlClass, allControlClasses) {
  ...
  var controlTrumbowyg = function (_controlTextarea) {
    ...
    controlTrumbowyg.prototype.configure = function configure() {
    ...
    controlTrumbowyg.prototype.build = function build() {
    ...
    controlTrumbowyg.prototype.onRender = function onRender(evt) {
      var _this2 = this;
    ...
    _createClass(controlTrumbowyg, null, [{
      key: 'definition',
      get: function get() {
        return {
          i18n: {
