...
var FormBuilder = function FormBuilder(opts, element) {
  ...
  var defaultFieldAttrs = function defaultFieldAttrs(type) {
    ...
    var typeAttrsMap = {
      ...
      flipswitch: ['required', 'label', 'description', 'className', 'name', 'other', 'options']
    };
    typeAttrsMap['checkbox-group'] = ['required', 'label', 'description', 'toggle', 'inline', 'className', 'name', 'access', 'other', 'subtype', 'options'];
    typeAttrsMap['radio-group'] = ['required', 'label', 'description', 'toggle', 'inline', 'className', 'name', 'access', 'other', 'subtype', 'options'];
